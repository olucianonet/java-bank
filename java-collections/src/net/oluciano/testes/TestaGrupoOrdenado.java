...
public class TestaGrupoOrdenado {
	...
	public static void main(String[] args) {
		...
		// Ordenando alunos a partir da lista somente leitura.
		List<Aluno> copiaDeAlunos = new ArrayList<Aluno>(g1.getAlunos());				
		Collections.sort(copiaDeAlunos);

		System.out.println(copiaDeAlunos);
		
		System.out.println("Soma das idades: " + g1.getSomaIdades());
	}
